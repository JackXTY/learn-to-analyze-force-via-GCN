...
train_step = tf.train.AdagradOptimizer(1e-2).minimize(loss_MSE)
...
saver.restore(sess, "/tmp/Network_v1.2_test_stress_model.ckpt")
#sess.run(tf.initialize_all_variables())

# For AdamOptimizer with loss_MSE:
#   /tmp/Network_v1.1_stress_model.ckpt 
#   90000 times; loss 5*10^7; accuracy: 10

# For AdagradOptimizer with loss_MSE :
#   /tmp/Network_v1.2_stress_model.ckpt (3e-3) 
#   400000 times; loss 5*10^6; accuracy: 7.7
#   
#   /tmp/Network_v1.2_test_stress_model.ckpt (1e-2)
#   many times...; loss 4.5*10^6; accuracy:7.5
...
save_path = saver.save(sess, "/tmp/Network_v1.2_test_stress_model.ckpt")
