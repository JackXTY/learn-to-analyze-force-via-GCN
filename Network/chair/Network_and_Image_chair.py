...
def run_with_input(x,y,z,rst_path):
    ...
    predict_pngpath = 'D:\\summer_research\\chair\\png\\displacement\\prediction_displacement'+str(x)+'_'+str(y)+'_'+str(z)+'.png'
    ...
    image = Image.alpha_composite(image, tmp)
    image = image.convert("RGB")
    circle='D:\\summer_research\\chair\\png\\displacement\\prediction_circle_displacements'+str(x)+'_'+str(y)+'_'+str(z)+'.png'
    image.save(circle)
