...
ListView.ItemValue = "faces_5_2147483649";

SC.doInsertEnvironmentFixedDisplacement();
ListView.ActivateItem("Scoping Method");
ListView.ItemValue = "Named Selection" ;
ListView.ActivateItem("Named Selection");
ListView.ItemValue = "faces_5_2147483655";
...
for (var i=0;i<20;i++)
{
    var force_magnitude = Math.random()*40+20;
    ...
    for(var j=0;j<1;j++)
    {
        ...
        ListView.ItemValue = "Named Selection" ;
        ListView.ActivateItem("Named Selection");
        ListView.ItemValue = "faces_3_2147483655" ;
        ListView.ActivateItem("Define By");
        ListView.ItemValue = "Components" ;
        ListView.ActivateItem("X Component");
        ...
        //save file
        var filespec='D:/XiaoTianyi/Real/assembly/pro/10_7_2019_files/dp0/SYS/MECH/file1.rst';
        var strSourFile = 'D:/XiaoTianyi/Real/assembly/pro/10_7_2019_files/dp0/SYS/MECH/file.rst';
        
        var objFSO = new ActiveXObject("Scripting.FileSystemObject");
        if(!objFSO.FileExists(filespec)){
            var strDestFile = 'D:/XiaoTianyi/Real/assembly/rst/1_'+x+'_'+y+'_'+z+'.rst';
            var strPath = objFSO.CopyFile(strSourFile, strDestFile);
        }
        else{
            var strDestFile = 'D:/XiaoTianyi/Real/assembly/rst/0_'+x+'_'+y+'_'+z+'.rst';
            var strPath = objFSO.CopyFile(strSourFile, strDestFile);
        }
    }
}
