...
ListView.ItemValue = "faces_3_2147483649";
...
for (var i=0;i<198;i++)
{
    var force_magnitude = Math.random()*500+60;
    ...
    for(var j=0;j<2;j++)
    {
        ...
        ListView.ItemValue = "Named Selection" ;
        ListView.ActivateItem("Named Selection");
        ListView.ItemValue = "faces_3_2147483652" ;
        ListView.ActivateItem("Define By");
        ListView.ItemValue = "Components" ;
        ListView.ActivateItem("X Component");
        ...
        //save file
        var filespec='D:/XiaoTianyi/Real/T/pro/12_8_2019_files/dp0/SYS/MECH/file1.rst';
        var strSourFile = 'D:/XiaoTianyi/Real/T/pro/12_8_2019_files/dp0/SYS/MECH/file.rst';
        
        var objFSO = new ActiveXObject("Scripting.FileSystemObject");
        if(!objFSO.FileExists(filespec)){
            var strDestFile = 'D:/XiaoTianyi/Real/T/rst/1_'+x+'_'+y+'_'+z+'.rst';
            var strPath = objFSO.CopyFile(strSourFile, strDestFile);
        }
        else{
            var strDestFile = 'D:/XiaoTianyi/Real/T/rst/0_'+x+'_'+y+'_'+z+'.rst';
            var strPath = objFSO.CopyFile(strSourFile, strDestFile);
        }
    }
}
